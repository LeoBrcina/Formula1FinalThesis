...
MODEL_FILE = os.path.join(BASE_DIR, "../Models/podium_rf_tuned_modern.pkl")  # Tuned RandomForests model
...
# --- STEP 2: Load Prediction Dataset (Australia GP) ---
...
# --- OUTPUT TO TERMINAL ---
print("\nPredicted Podium for 2025 Australia GP (Top 3) [RandomForests]:")
