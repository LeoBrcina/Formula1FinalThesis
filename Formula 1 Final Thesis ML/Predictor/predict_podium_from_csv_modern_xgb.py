...
MODEL_FILE = os.path.join(BASE_DIR, "../Models/podium_xgb_tuned_modern.pkl")  # Tuned XGBoost model
PREDICTION_FILE = os.path.join(BASE_DIR, "../DataML/podium_prediction_2025_japan_normalized.csv")

# --- STEP 1: Load the Trained XGBoost Model ---
...
# --- OUTPUT TO TERMINAL ---
print("\nPredicted Podium for 2025 Australia GP (Top 3) [XGBoost]:")
