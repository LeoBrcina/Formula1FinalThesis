...
MODEL_FILE = os.path.join(BASE_DIR, "../Models/podium_xgb_tuned_historical.pkl")  # Historical XGBoost model
PREDICTION_FILE = os.path.join(BASE_DIR, "../DataML/podium_prediction_2025_japan_normalized.csv")

# --- STEP 1: Load the Trained Historical XGBoost Model ---
print("Loading historical XGBoost model...")
...
# --- OUTPUT TO TERMINAL ---
print("\nPredicted Podium for 2025 Australia GP (Top 3) [Historical XGBoost]:")
