...
MODEL_FILE = os.path.join(BASE_DIR, "../Models/podium_rf_tuned_historical.pkl")  # Historical RF model
PREDICTION_FILE = os.path.join(BASE_DIR, "../DataML/podium_prediction_2025_japan_normalized.csv")

# --- STEP 1: Load the Trained Historical Random Forest Model ---
print("Loading historical Random Forest model...")
...
# --- OUTPUT TO TERMINAL ---
print("\nPredicted Podium for 2025 Australia GP (Top 3) [Historical RandomForests]:")
