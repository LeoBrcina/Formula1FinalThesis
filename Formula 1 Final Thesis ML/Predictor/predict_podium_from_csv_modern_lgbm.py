...
MODEL_FILE = os.path.join(BASE_DIR, "../Models/podium_lgbm_tuned_modern.pkl")  # Tuned LightGBM model
...
print("Loading tuned LightGBM model...")
...
# --- OUTPUT TO TERMINAL ---
print("\nPredicted Podium for 2025 Australia GP (Top 3) [LightGBM]:")
